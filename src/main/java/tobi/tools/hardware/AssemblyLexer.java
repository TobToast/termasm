...
public class AssemblyLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"HEX_NUMBER", "BIN_NUMBER", "DEC_NUMBER", "ARROW", "REGISTER", "MNEMONIC", 
			"ID", "WS", "COMMENT", "MULTI_COMMENT"
		};
	}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 22:
			return MNEMONIC_sempred((RuleContext)_localctx, predIndex);
		}
		return true;
	}
	private boolean MNEMONIC_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
			return  MNEMONICS.contains(getText().toLowerCase()) ;
		}
		return true;
	}
